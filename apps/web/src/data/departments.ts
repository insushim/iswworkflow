...
export const dutyGuideMapping: Record<string, string[]> = {
  ...
  'academic-affairs': ['교무부', '교무기획부', '학교운영위원회', '학부모회', '인사자문위원회', '교무행정', '나이스', 'NEIS', '학적관리', '성적관리'],
  'student-life': ['생활지도부', '학교폭력대책심의위원회', '인권교육', '학폭', '학교폭력', '생활지도'],
  'class-teacher': ['학년부', '학급담임', '담임', '1학년 담임', '2학년 담임', '3학년 담임', '4학년 담임', '5학년 담임', '6학년 담임', '현장체험학습', '졸업앨범', '졸업식', '학급경영', '학급운영', '생활기록부', '생기부', '학부모상담'],
...
export const dutyToTaskCategoryMapping: Record<string, string[]> = {
  '학급경영': ['학년부', '학급담임', '담임', '1학년 담임', '2학년 담임', '3학년 담임', '4학년 담임', '5학년 담임', '6학년 담임', '학교생활기록부', '생기부', '학급운영', '졸업앨범', '졸업식'],
  '학부모': ['학부모회', '학부모상담', '가정통신문', '현장체험학습', '학부모'],
  '체험학습': ['현장체험학습', '창의체험부', '현장학습', '수학여행', '졸업여행'],
  '안전': ['안전부', '학교안전공제회', '녹색어머니회', '생존수영교육', '안전교육', '안전', '7대안전교육'],
  '교육과정': ['연구부', '교무부', '교무기획부', '교원능력개발평가', '학교평가', '교과전담', '연구', '수업연구'],
